...
import {getTccPath}  from "./utils.mjs";
import {loadTemplate}  from "./tpl.mjs";
...
export const PROCESS_ERROR_CODE  = {
    SOURCE_UNDEFINED         : 9,
    SOURCE_NOT_FOUND         : 11,
 ...
 */
export const runBinary  = function (execPath, {
    execArgs = [],
    cwd = ""
} = {})
{
 ...
 */
export const compileSource  = function (filePath, {
    binType = BIN_TYPE.EXECUTABLE,
    output = "",
    outputDir = "",
    defs = [],
 ...
 * @returns {{fileName, success: boolean, compiledPath?: string}}
 */
export const compileLibrary  = function (filePath, {outputDir = ""} = {})
{
    return compileSource(filePath, {binType: BIN_TYPE.SHARED, outputDir})
}

export const registerCall  = function ()
{
 ...
 * @returns {*}
 */
export const runFile  = function (filePath, {execArgs = [], defs = [], output = "", outputDir = ""} = {})
{
 ...
 * @returns {*}
 */
export const runLive  = function (filePath, {execArgs = [], defs = [], outputDir = ""} = {})
{
...
export const runString  = function (str, {execArgs = [], defs = [], outputDir = ""} = {})
{
 ...
 * @returns {*|null}
 */
export const invokeFunction  = function (funcName, dll, {outputDir = "./"} = {})
{
    // Compile the DLL
...
export const loadFunctions  = function ()
{
